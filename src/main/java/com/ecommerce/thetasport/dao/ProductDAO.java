...
public class ProductDAO {
    ...
    private static int result; // risultato somma degli item per singola categoria e sotto-categoria
     ...
     * @throws SQLException Definisce un'eccezione generale che si può generare
     */
    public static void insertListOrder( Map<ItemElement, Integer> items, String email, double total ) throws SQLException {
        try {
            connection = DatabaseConnection.getInstance().getConnection();
